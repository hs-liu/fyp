#!/bin/bash
#SBATCH --job-name=groq_experiment
#SBATCH --output=/vol/bitbucket/hl2622/fyp/logs/init_exp/exp_groq_%j.log
#SBATCH --error=/vol/bitbucket/hl2622/fyp/logs/init_exp/exp_groq_%j.err
