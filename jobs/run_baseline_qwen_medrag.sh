#!/bin/bash
#SBATCH --job-name=medrag_qwen
#SBATCH --output=/vol/bitbucket/hl2622/fyp/logs/baselines/medrag_qwen_%j.log
#SBATCH --error=/vol/bitbucket/hl2622/fyp/logs/baselines/medrag_qwen_%j.err
...
python scripts/evaluate_baseline_qwen_medrag.py