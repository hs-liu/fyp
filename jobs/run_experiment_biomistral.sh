...
#SBATCH --output=/vol/bitbucket/hl2622/fyp/logs/exp_biomistral_%j.log
#SBATCH --error=/vol/bitbucket/hl2622/fyp/logs/exp_biomistral_%j.err
...
python scripts/experiment_biomistral.py