...
#SBATCH --output=/vol/bitbucket/hl2622/fyp/logs/analysis/raw_vs_medhirerag_analysis_%j.log
#SBATCH --error=/vol/bitbucket/hl2622/fyp/logs/analysis/raw_vs_medhirerag_analysis_%j.err
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
