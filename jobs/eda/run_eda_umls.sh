#!/bin/bash
#SBATCH --job-name=eda_umls
#SBATCH --partition=a30
#SBATCH --output=/vol/bitbucket/hl2622/fyp/logs/eda/eda_umls_%j.log
#SBATCH --error=/vol/bitbucket/hl2622/fyp/logs/eda/eda_umls_%j.err
#SBATCH --ntasks=1
...
python scripts/eda/eda_umls_separate.py
