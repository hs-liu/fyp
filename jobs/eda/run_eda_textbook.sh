#!/bin/bash
#SBATCH --job-name=eda_textbook
#SBATCH --partition=a30
#SBATCH --output=/vol/bitbucket/hl2622/fyp/logs/eda/eda_textbook_%j.log
#SBATCH --error=/vol/bitbucket/hl2622/fyp/logs/eda/eda_textbook_%j.err
#SBATCH --ntasks=1
...
python scripts/eda/eda_textbook_separate.py
