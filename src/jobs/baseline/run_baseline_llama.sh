...
#SBATCH --output=/vol/bitbucket/hl2622/fyp/src/logs/llama_%j.log
#SBATCH --error=/vol/bitbucket/hl2622/fyp/src/logs/llama_%j.err
...
python scripts/baselines/evaluate_baseline_llama.py