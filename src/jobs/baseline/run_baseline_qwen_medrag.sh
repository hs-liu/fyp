...
#SBATCH --output=/vol/bitbucket/hl2622/fyp/src/logs/baselines/medrag_qwen_%j.log
#SBATCH --error=/vol/bitbucket/hl2622/fyp/src/logs/baselines/medrag_qwen_%j.err
