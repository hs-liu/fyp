#!/bin/bash
#SBATCH --job-name=medqa_qwen
#SBATCH --output=/vol/bitbucket/hl2622/fyp/src/logs/baselines/qwen_%j.log
#SBATCH --error=/vol/bitbucket/hl2622/fyp/src/logs/baselines/qwen_%j.err
...
python scripts/baselines/evaluate_baseline_qwen.py