...
#SBATCH --output=/vol/bitbucket/hl2622/fyp/src/logs/knowledge_graph/embedded_graph_viz_%j.log
#SBATCH --error=/vol/bitbucket/hl2622/fyp/src/logs/knowledge_graph/embedded_graph_viz_%j.err
#SBATCH --ntasks=1
