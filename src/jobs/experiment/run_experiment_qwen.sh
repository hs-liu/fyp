#!/bin/bash
#SBATCH --job-name=qwen_experiment
#SBATCH --output=/vol/bitbucket/hl2622/fyp/src/logs/init_exp/exp_qwen_%j.log
#SBATCH --error=/vol/bitbucket/hl2622/fyp/src/logs/init_exp/exp_qwen_%j.err
...
python scripts/rag_experiments/experiment_qwen.py