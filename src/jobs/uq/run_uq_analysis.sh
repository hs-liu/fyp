...
#SBATCH --output=/vol/bitbucket/hl2622/fyp/logs/analysis/uq_analysis_sensi_%j.log
#SBATCH --error=/vol/bitbucket/hl2622/fyp/logs/analysis/uq_analysis_sensi_%j.err
