#!/bin/bash
#SBATCH --job-name=uq_qwen
#SBATCH --output=/vol/bitbucket/hl2622/fyp/src/logs/uq_exp/qwen_%j.log
#SBATCH --error=/vol/bitbucket/hl2622/fyp/src/logs/uq_exp/qwen_%j.err
...
python scripts/uq_experiments/uq_experiment_qwen.py