...
#SBATCH --output=/vol/bitbucket/hl2622/fyp/src/logs/eda/eda_textbook_%j.log
#SBATCH --error=/vol/bitbucket/hl2622/fyp/src/logs/eda/eda_textbook_%j.err
#SBATCH --ntasks=1
...
python scripts/eda/eda_textbook.py
