#!/bin/bash
#SBATCH --job-name=eda_pubmed
#SBATCH --partition=a30
#SBATCH --output=/vol/bitbucket/hl2622/fyp/logs/eda/eda_pubmed_%j.log
#SBATCH --error=/vol/bitbucket/hl2622/fyp/logs/eda/eda_pubmed_%j.err
#SBATCH --ntasks=1
...
python scripts/eda/eda_pubmed_separate.py
