...
#SBATCH --output=/vol/bitbucket/hl2622/fyp/src/logs/eda/eda_pubmed_%j.log
#SBATCH --error=/vol/bitbucket/hl2622/fyp/src/logs/eda/eda_pubmed_%j.err
#SBATCH --ntasks=1
...
python scripts/eda/eda_pubmed.py
