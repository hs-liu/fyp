...
#SBATCH --output=/vol/bitbucket/hl2622/fyp/src/logs/eda/eda_umls_%j.log
#SBATCH --error=/vol/bitbucket/hl2622/fyp/src/logs/eda/eda_umls_%j.err
#SBATCH --ntasks=1
...
python scripts/eda/eda_umls.py
