...
from scripts.rag.retrieval_utils import build_rag_prompt, load_checkpoint, save_checkpoint, save_summary
...
save_summary(SUMMARY_PATH, f"BioMistral-7B (My RAG v5, remove confidence) Accuracy: {accuracy:.2%} ({n_correct}/{len(results)})")
